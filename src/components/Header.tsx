      ...
      <header className="bg-gradient-to-r from-brand to-brand-dark text-white">
        <div className="w-full px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between gap-2 sm:gap-4 py-3">
            <div className="text-xl sm:text-2xl font-bold">Knowledge Portal</div>
    ...
    <header className="bg-gradient-to-r from-brand to-brand-dark text-white">
      <div className="w-full px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between gap-2 sm:gap-4 py-3">
          ...
          <nav className="hidden lg:flex flex-wrap items-center gap-1 xl:gap-2">
            {navItems.map((item) => {
              ...
              return (
                <Link
                  ...
                  href={item.href}
                  className={
                    `px-2 xl:px-3 py-2 rounded transition-colors text-sm xl:text-base ${
          ...
          <div className="flex items-center gap-2 sm:gap-4 flex-shrink-0">
            ...
            <div className="relative">
              ...
              >
                <div className="w-6 h-6 sm:w-8 sm:h-8 rounded-full bg-white/20 flex items-center justify-center text-xs sm:text-sm font-bold overflow-hidden">
                  {user?.avatar ? (
                    <img 
                      src={user.avatar} 
                      alt="Avatar" 
                      ...
                      onError={(e) => {
                        console.log(`[Header] アバター読み込みエラー:`, user.avatar);
                ...
                <span className="hidden sm:block text-sm lg:text-base">{user?.display_name}</span>
